...
const ApplicationCard = ({ job }) => {
  ...
  <p className='text-base text-start mr-10'>{job?.location}</p>
  <p className='text-base text-start'>{job?.jobTitle}</p>
</div>


      <div className='w-1/4 h-full flex flex-col items-center'>
      
        <p className='text-green-600 font-semibold'>Applied</p>
